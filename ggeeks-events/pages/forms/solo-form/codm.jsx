      ...
      <div className='md:px-40 md:py-10 px-10 py-3'>
        <form name="CODM-Form" action="" method="POST" className='grid grid-cols-1  md:px-10 px-2 justify-center form-font' onSubmit={handleSubmit}>
          ...
          <input name="phone-number" type="tel" placeholder='Phone Number'
            ...
            className='white-glassmorphism my-3 bg-transparent px-3 py-5' required={true} onChange={(e) => setPhone(e.target.value)} value={phoneNumber} />
          ...
          <input name="username" type="text" placeholder='CODM Username' className='white-glassmorphism bg-transparent px-3 my-3 py-5' required={true} onChange={(e) => setUsername(e.target.value)} value={username} />
