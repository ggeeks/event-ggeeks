...
return (
    ...
    <div className='md:px-40 md:py-10 px-10 py-3'>
      <form action="" method="get" className='grid grid-cols-1  md:px-10 px-2 justify-center'>
        ...
        <button type="submit" className='md:text-2xl text-lg blue-glassmorphism hover:text-orange-500 md:1/5 w-3/5 justify-center rounded-xl my-3 px-3 py-4'>Register</button>
      </form>
    </div>
  </div>
)}
