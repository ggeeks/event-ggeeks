  ...
  return (
    ...
    <div className=' py-2'>
      <form action="" method="get" className='grid grid-cols-1  md:px-10 px-2 justify-center '>
        ...
        <button type="submit" className='md:text-2xl text-l blue-glassmorphism hover:text-orange-500 w-1/5 justify-center rounded-xl my-3 px-3 py-4   ' ><h1 className=''>Register</h1></button>
      </form>
    </div>
  </div>
  )
